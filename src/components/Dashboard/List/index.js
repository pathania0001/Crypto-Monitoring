    ...
    <Link to={`/coin/${coin.id}`}>
      ...
      >
        ...
        <Tooltip title="Coin Total Volume" placement="bottom-end">
          ...
          {(currency==="USD")?"$"+(coin.total_volume.toLocaleString()) :
        ...
        <td className="coin-name mobile">{(currency==="USD")?"$"+convertNumberinUSD(coin.total_volume.toLocaleString()) :
            ("₹"+convertNumberinINR(coin.total_volume.toLocaleString()))}</td>
        <td
